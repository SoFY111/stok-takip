<div class=" {{$type === 'product' ? 'hover-products' : 'hover' }} hover-s d-flex flex-sm-row flex-row align-items-center justify-content-center w-100 mt-2 bg-white p-2 rounded flex-sm-row ">
