...
<head>
    ...
    <link href="{{asset('back')}}/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        ...
        <div class="col-xl-12 col-lg-12 col-md-10">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-7 d-none d-lg-block bg-password-image"></div>
                        <div class="col-lg-5">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Oraganik mi Organik</h1>
                                </div>
                                @if($errors->any())
